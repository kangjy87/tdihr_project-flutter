...
class _FlutterWifiIoTState extends State<FlutterWifiIoT> {
                  ...
                  switch (poCommand.command) {
                    case "Connect":
                      WiFiForIoTPlugin.connect(STA_DEFAULT_SSID,
                          password: STA_DEFAULT_PASSWORD, joinOnce: true, security: STA_DEFAULT_SECURITY);
                      break;
                    case "Remove":
        ...
        if (_sSSID == STA_DEFAULT_SSID) {
          ...
          htPrimaryWidgets.addAll(<Widget>[
            MaterialButton(
              ...
              onPressed: () {
                WiFiForIoTPlugin.connect(STA_DEFAULT_SSID,
                    password: STA_DEFAULT_PASSWORD, joinOnce: true, security: NetworkSecurity.WPA);
              },
            ),
          ]);
        }
  ...
  //   slog.i("Flutter Sample : Wifi Scan");
  //   return Scaffold(
  //     appBar: AppBar(
  //       title: Text('wifiscan'.tr),
  //     ),
  //   );
  // }
}
